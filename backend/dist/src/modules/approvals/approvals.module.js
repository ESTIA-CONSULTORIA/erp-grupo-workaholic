...
exports.ApprovalsModule = ApprovalsModule = __decorate([
    (0, common_1.Module)({ imports: [prisma_module_1.PrismaModule], controllers: [approvals_controller_1.ApprovalsController], providers: [approvals_service_1.ApprovalsService], exports: [approvals_service_1.ApprovalsService] })
], ApprovalsModule);
