...
let LegalController = class LegalController {
    ...
    generate(cid, req, body) { return this.svc.generate(cid, req.user.sub, body); }
    update(id, body) { return this.svc.update(id, body); }
    sign(id, req, body) { return this.svc.sign(id, req.user.sub, body.byEmployee || false); }
};
...
], LegalController.prototype, "get", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], LegalController.prototype, "generate", null);
__decorate([
    (0, common_1.Put)(':id'),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object, Object]),
    __metadata("design:returntype", void 0)
], LegalController.prototype, "sign", null);
exports.LegalController = LegalController = __decorate([
    (0, common_1.Controller)('companies/:companyId/legal'),
