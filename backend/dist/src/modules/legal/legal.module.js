...
exports.LegalModule = LegalModule = __decorate([
    (0, common_1.Module)({ imports: [prisma_module_1.PrismaModule], controllers: [legal_controller_1.LegalController], providers: [legal_service_1.LegalService], exports: [legal_service_1.LegalService] })
], LegalModule);
