...
exports.IncidentsModule = IncidentsModule = __decorate([
    (0, common_1.Module)({ imports: [prisma_module_1.PrismaModule], controllers: [incidents_controller_1.IncidentsController], providers: [incidents_service_1.IncidentsService], exports: [incidents_service_1.IncidentsService] })
], IncidentsModule);
