    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.login = function (email, password) {
            return __awaiter(this, void 0, void 0, function () {
                var user, valid, companies, payload;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            if (!valid)
                                throw new common_1.UnauthorizedException('Credenciales inválidas');
                            companies = user.companyRoles.map(function (cr) { return ({
        ...
        AuthService_1.prototype.verifyPin = function (companyId, pin) {
            return __awaiter(this, void 0, void 0, function () {
                var users;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.userCompanyRole.findMany({
                                where: {
                                    companyId: companyId,
                                    role: { code: { in: ['gerente', 'admin', 'administrador'] } },
                                    user: { pin: pin, isActive: true },
                                },
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, { authorized: true, authorizedBy: users[0].user.name }];
                    }
                });
            });
        };
        AuthService_1.prototype.setPin = function (userId, pin) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (pin.length !== 4 || !/^\d{4}$/.test(pin))
                        throw new Error('El PIN debe ser de 4 dígitos');
                    return [2 /*return*/, this.prisma.user.update({ where: { id: userId }, data: { pin: pin } })];
                });
            });
        };
