...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.verifyPin = function (body) {
            return this.auth.verifyPin(body.companyId, body.pin);
        };
        AuthController_1.prototype.setPin = function (body) {
    ...
    (function () {
        ...
        _verifyPin_decorators = [(0, common_1.Post)('verify-pin')];
        _setPin_decorators = [(0, common_1.Put)('set-pin')];
        ...
        __esDecorate(_classThis, null, _setPin_decorators, { kind: "method", name: "setPin", static: false, private: false, access: { has: function (obj) { return "setPin" in obj; }, get: function (obj) { return obj.setPin; } }, metadata: _metadata }, null, _instanceExtraInitializers);
