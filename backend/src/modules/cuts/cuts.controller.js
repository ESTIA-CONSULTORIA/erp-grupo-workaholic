...
var CutsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Cuts'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(auth_guards_1.JwtAuthGuard), (0, common_1.Controller)('companies/:companyId/cuts')];
    ...
    var CutsController = _classThis = /** @class */ (function () {
        function CutsController_1(svc) {
            this.svc = (__runInitializers(this, _instanceExtraInitializers), svc);
        }
        CutsController_1.prototype.findAll = function (cid, period) {
            return this.svc.findAll(cid, period);
        };
        CutsController_1.prototype.create = function (cid, req, body) {
            return this.svc.create(cid, req.user.sub, body);
        };
        CutsController_1.prototype.submit = function (id) { return this.svc.submit(id); };
        CutsController_1.prototype.approve = function (id) { return this.svc.approve(id); };
        return CutsController_1;
    }());
    __setFunctionName(_classThis, "CutsController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _findAll_decorators = [(0, common_1.Get)()];
        _create_decorators = [(0, common_1.Post)()];
        _submit_decorators = [(0, common_1.Put)(':id/submit')];
        ...
        CutsController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CutsController = _classThis;
}();
