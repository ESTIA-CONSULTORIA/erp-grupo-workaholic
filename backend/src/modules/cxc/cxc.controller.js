...
var CxcController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('CxC'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(auth_guards_1.JwtAuthGuard), (0, common_1.Controller)('companies/:companyId/cxc')];
    ...
    var CxcController = _classThis = /** @class */ (function () {
        function CxcController_1(svc) {
            this.svc = (__runInitializers(this, _instanceExtraInitializers), svc);
        }
        CxcController_1.prototype.findAll = function (cid, period, status, clientId) { return this.svc.findAll(cid, period, status, clientId); };
        CxcController_1.prototype.summary = function (cid, clientId) { return this.svc.getSummary(cid, clientId); };
        CxcController_1.prototype.addPayment = function (cid, receivableId, body) {
            return this.svc.addPayment(receivableId, body.cashAccountId, body);
        };
        return CxcController_1;
    }());
    __setFunctionName(_classThis, "CxcController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _findAll_decorators = [(0, common_1.Get)(), (0, common_1.Get)()];
        _summary_decorators = [(0, common_1.Get)('summary')];
        _addPayment_decorators = [(0, common_1.Post)(':id/payments')];
        ...
        CxcController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CxcController = _classThis;
}();
