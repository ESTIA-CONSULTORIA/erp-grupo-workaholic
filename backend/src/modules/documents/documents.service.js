...
var DocumentsService = function () {
    ...
    var DocumentsService = _classThis = /** @class */ (function () {
        function DocumentsService_1(prisma) {
            this.prisma = prisma;
        }
        DocumentsService_1.prototype.findAll = function (companyId, status) {
        ...
        DocumentsService_1.prototype.create = function (companyId, userId, data) {
        ...
        DocumentsService_1.prototype.extract = function (companyId, docId) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, { message: 'Extracción iniciada' }];
                    }
                });
            });
        };
        DocumentsService_1.prototype.validate = function (docId, validatedData) {
            return this.prisma.document.update({
                where: { id: docId },
                data: { status: 'VALIDADO', validatedJson: validatedData },
            });
        };
        DocumentsService_1.prototype.reject = function (docId) {
            return this.prisma.document.update({
                where: { id: docId },
